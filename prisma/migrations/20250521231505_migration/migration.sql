...
CREATE TABLE `ScheduleException` (
    ...
    INDEX `ScheduleException_userId_startDate_endDate_idx`(`userId`, `startDate`, `endDate`),
    INDEX `ScheduleException_scheduleId_startDate_endDate_idx`(`scheduleId`, `startDate`, `endDate`),
    INDEX `ScheduleException_workplaceId_startDate_endDate_idx`(`workplaceId`, `startDate`, `endDate`),
    INDEX `ScheduleException_positionId_startDate_endDate_idx`(`positionId`, `startDate`, `endDate`),
    INDEX `ScheduleException_companyId_startDate_endDate_idx`(`companyId`, `startDate`, `endDate`),
    UNIQUE INDEX `ScheduleException_scheduleId_startDate_endDate_key`(`scheduleId`, `startDate`, `endDate`),
    UNIQUE INDEX `ScheduleException_userId_startDate_endDate_key`(`userId`, `startDate`, `endDate`),
    UNIQUE INDEX `ScheduleException_workplaceId_startDate_endDate_key`(`workplaceId`, `startDate`, `endDate`),
    UNIQUE INDEX `ScheduleException_positionId_startDate_endDate_key`(`positionId`, `startDate`, `endDate`),
    UNIQUE INDEX `ScheduleException_companyId_startDate_endDate_key`(`companyId`, `startDate`, `endDate`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
